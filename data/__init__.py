...
def build_vid_transforms(config):
    ...
    if config.AUG.TEMPORAL_SAMPLING_MODE == 'tsn':
        ...
        raise KeyError("Invalid temporal sampling mode '{}'".format(config.AUG.TEMPORAL_SAMPLING_MODE))
...
def build_dataloader(config):
    ...
    # image dataset
        ...
        if config.DATA.DATASET == 'prcc':
            ...
            return trainloader, queryloader_same, queryloader_diff, galleryloader, dataset
        else:
